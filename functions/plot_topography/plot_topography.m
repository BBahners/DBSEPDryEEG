...
% ----------------------------------------------------------------------- %
function [h,ch_x,ch_y] = plot_topography(ch_list, values, make_contour, system, ...
    ...
    plot(head_x, head_y, 'Color', 'k', 'LineWidth',1);
    hold on;
    ...
    plot(nose_x, nose_y, 'Color', 'k', 'LineWidth',1);
    hold on;
    ...
    plot(ear_x_right+head_rho+offset, ear_y_right, 'Color', 'k', 'LineWidth',1); hold on;
    plot(ear_x_left-head_rho-offset, ear_y_left, 'Color', 'k', 'LineWidth',1); hold on;
