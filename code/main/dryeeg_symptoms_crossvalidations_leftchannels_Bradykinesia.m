...
rmappath=dryeeg_result_path(repoRoot, 'symptoms_crossvalidations_Bradykinesia'); % results path
...
tab=readtable(dryeeg_data_path(repoRoot, 'metadata/UPDRS_dryEEG_ImprovementsOmitNanUp_Brady.xlsx'));
...
ax=gcf;
%ax.Colormap=cmap;
cmp=ea_colorgradient(256,[1 1 1],[1 1 1],[0.098 0.6431 1]);
ax.Colormap=cmp;
...
cb = colorbar();
        ...
        ax=gca;
        ax.TickDir="out";
        saveas(h5,[rmappath,'topo_',timwinlab{iwin},'_blue','.png']);
    end
